...
public class TiDBClob extends TiDBBlob implements Clob, NClob, Serializable {
   ...
   * @param length length
   */
  public TiDBClob(byte[] bytes, int offset, int length) {
